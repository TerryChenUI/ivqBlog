...
angular.module('app.admin.setting')
    .controller('AccountCtrl', ['$rootScope', '$scope', '$state', 'SweetAlert', 'AccountService', 'AuthService', 'Tool', ($rootScope, $scope, $state, SweetAlert, AccountService, AuthService, Tool) => {
        ...
        $scope.updatePassword = () => {
            ...
            AccountService.updatePassword($scope.model._id, modifyModel).then((data) => {
        ...
        $scope.saveAccount = () => {
            ...
            if (Object.keys(modifyModel).length) {
                AccountService.update($scope.model._id, modifyModel).then((data) => {
                    AuthService.setCredentials(data);
                    SweetAlert.updateSuccessfully();
                });
            }
